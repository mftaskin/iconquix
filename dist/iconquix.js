class iconQuix extends HTMLElement {
    ...
    render() {
        ...
        const svgString = iconQuixData[this.getAttribute('icon')] ? `<svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 64 64">${iconQuixData[this.getAttribute('icon')]}</svg>` : `<svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 64 64">${iconQuixData['noicon-selected']}</svg>`;
